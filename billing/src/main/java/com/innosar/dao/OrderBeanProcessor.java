...
public class OrderBeanProcessor extends BeanProcessor {
	...
	public <T> List<T> toBeanList(ResultSet rs, Class<T> type)
		...
		List<OrderBean> beanList = new LinkedList<>();
	...
	private OrderBean getResultObject(ResultSet rs) throws SQLException {
