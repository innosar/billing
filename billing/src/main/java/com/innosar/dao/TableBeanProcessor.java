...
public class TableBeanProcessor extends BeanProcessor {
	...
	public <T> List<T> toBeanList(ResultSet rs, Class<T> type)
		...
		List<TableBean> beanList = new LinkedList<>();
	...
	private TableBean getResultObject(ResultSet rs) throws SQLException {
